...
const RegionModal = ({ isOpen, onClose, regionData, crimeStats }) => {
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-emerald-50 rounded-xl p-4 text-center">
              <div className="text-2xl font-bold text-emerald-600">{stats.solved}</div>
          ...
          <Tabs defaultValue="chart" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-4">
              <TabsTrigger value="chart" className="text-sm">Grafik Jenis</TabsTrigger>
              <TabsTrigger value="trend" className="text-sm">Tren Bulanan</TabsTrigger>
              <TabsTrigger value="cases" className="text-sm">Kasus Terbaru</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="chart" className="mt-0">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-slate-50 rounded-xl p-4">
                  <h4 className="text-sm font-medium text-slate-700 mb-3">Distribusi Kasus</h4>
                ...
                {/* Pie Chart */}
                <div className="bg-slate-50 rounded-xl p-4">
                  <h4 className="text-sm font-medium text-slate-700 mb-3">Proporsi Jenis</h4>
                  <ResponsiveContainer width="100%" height={200}>
                    <PieChart>
                      <Pie
                        data={stats.byType}
            ...
            <TabsContent value="trend" className="mt-0">
              <div className="bg-slate-50 rounded-xl p-4">
                <h4 className="text-sm font-medium text-slate-700 mb-3">Tren Kasus per Bulan (2025)</h4>
            ...
            <TabsContent value="cases" className="mt-0">
              <div className="space-y-3">
                {stats.recentCases.map((crime, index) => (
                  <div 
                    key={crime.id} 
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-medium text-slate-800">{crime.type}</div>
